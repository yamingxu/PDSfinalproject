...
function drawFlower(){
  ...
  //     push();
  //     imageMode(CENTER);
  //     translate(posX+i*cardWidth/5+random(20,30), posY_2+j*cardHeight/3+random(10,30));
  //     rotate(random(-0.5,0.5));
  //     image(img_stem[m],0+img_stem[m].width/60,0,img_stem[m].width/15,img_stem[m].height/15);
  //   //  noFill();
  //   //  stroke(0);
  //   //  rect(0+img_stem[m].width/60,0,50,50);
  //     pop();
  //     m+=1;
  //     console.log(m);
  //   }
